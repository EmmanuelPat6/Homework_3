...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'use_vision',
            default_value='false',
            description='Load the robot with the camera.',
        )
    )
    ...
    iiwa_sphere_world = PathJoinSubstitution(
    ...
    declared_arguments.append(DeclareLaunchArgument('gz_args', default_value=iiwa_sphere_world,
                                description='Arguments for gz_sim with camera'),)
    """
