...
class Iiwa_pub_sub : public rclcpp::Node
{
    public:
        ...
        node_handle_(std::shared_ptr<Iiwa_pub_sub>(this))
        {
            ...
            Eigen::Vector3d init_position(Eigen::Vector3d(init_cart_pose_.p.data) - Eigen::Vector3d(0,0,0.2)); //For Linear Trajectory with Cubic Polynomial
            ...
            if(cmd_interface_ == "position" || cmd_interface_ == "velocity"){
                ...
                acc_duration = 0.0;  //If you want a Trapezoidal Velocity Profile with an Inverse Dynamics Control in the JOINT SPACE, please set this quantity to 3.5
